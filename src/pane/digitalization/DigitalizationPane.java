...
public class DigitalizationPane extends Pane {
	...
	public DigitalizationPane(Image image) {
		...
		((JSpinner.DefaultEditor) getSampleSpinner().getEditor()).getTextField()
		...
		((JSpinner.DefaultEditor) getColorSpinner().getEditor()).getTextField()
				.setHorizontalAlignment(SwingConstants.CENTER);
	...
	public JSpinner getSampleSpinner() {
		return sampleSpinner;
	}

	public JSpinner getColorSpinner() {
		return colorSpinner;
	}

	public void setSampleSpinner(JSpinner sampleSpinner) {
		this.sampleSpinner = sampleSpinner;
	}

	public void setColorSpinner(JSpinner colorSpinner) {
