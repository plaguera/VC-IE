...
public class PixelColorPanel extends Panel {
	...
	public void setColor(int colorInt, int x, int y) {
		...
		getLabelRGB().setText("<html>[<font color='red'>" + color.getRed() + "</font>, <font color='green'>" + color.getGreen() + "</font>, <font color='blue'>" + color.getBlue() + "</font>]</html>");
		getLabelOthers().setText("<html>" + String.format("(#%02x%02x%02x)", color.getRed(), color.getGreen(), color.getBlue()) +
